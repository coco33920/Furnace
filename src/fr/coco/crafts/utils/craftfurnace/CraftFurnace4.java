 ...
 * craftfurnace
 */
public class CraftFurnace4 {

    private static CraftFurnace4 ourInstance = new CraftFurnace4();
    private Config config = new Config("Crafts");
    private FileConfiguration fc = config.getFileConfig();

    public static CraftFurnace4 getInstance() {
        return ourInstance;
    }

    private int matint = fc.getInt("Crafts.furnace.4.result");
    ...
    private int mat2int = fc.getInt("Crafts.furnace.4.furnaceCombustible");
    ...
    private int mat3int = fc.getInt("Crafts.furnace.4.ingredient");
