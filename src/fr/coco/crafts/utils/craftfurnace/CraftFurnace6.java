 ...
 * craftfurnace
 */
public class CraftFurnace6 {

    private static CraftFurnace6 ourInstance = new CraftFurnace6();
    private Config config = new Config("Crafts");
    private FileConfiguration fc = config.getFileConfig();

    public static CraftFurnace6 getInstance() {
        return ourInstance;
    }

    private int matint = fc.getInt("Crafts.furnace.6.result");
    ...
    private int mat2int = fc.getInt("Crafts.furnace.6.furnaceCombustible");
    ...
    private int mat3int = fc.getInt("Crafts.furnace.6.ingredient");
