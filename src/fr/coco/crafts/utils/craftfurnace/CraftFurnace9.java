 ...
 * craftfurnace
 */
public class CraftFurnace9 {

    private static CraftFurnace9 ourInstance = new CraftFurnace9();
    private Config config = new Config("Crafts");
    private FileConfiguration fc = config.getFileConfig();

    public static CraftFurnace9 getInstance() {
        return ourInstance;
    }

    private int matint = fc.getInt("Crafts.furnace.9.result");
    ...
    private int mat2int = fc.getInt("Crafts.furnace.9.furnaceCombustible");
    ...
    private int mat3int = fc.getInt("Crafts.furnace.9.ingredient");
