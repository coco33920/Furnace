 ...
 * craftfurnace
 */
public class CraftFurnace3 {

    private static CraftFurnace3 ourInstance = new CraftFurnace3();
    private Config config = new Config("Crafts");
    private FileConfiguration fc = config.getFileConfig();

    public static CraftFurnace3 getInstance() {
        return ourInstance;
    }

    private int matint = fc.getInt("Crafts.furnace.3.result");
    ...
    private int mat2int = fc.getInt("Crafts.furnace.3.furnaceCombustible");
    ...
    private int mat3int = fc.getInt("Crafts.furnace.3.ingredient");
