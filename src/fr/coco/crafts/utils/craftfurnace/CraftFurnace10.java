 ...
 * craftfurnace
 */
public class CraftFurnace10 {

    private static CraftFurnace10 ourInstance = new CraftFurnace10();
    private Config config = new Config("Crafts");
    private FileConfiguration fc = config.getFileConfig();

    public static CraftFurnace10 getInstance() {
        return ourInstance;
    }

    private int matint = fc.getInt("Crafts.furnace.10.result");
    ...
    private int mat2int = fc.getInt("Crafts.furnace.10.furnaceCombustible");
    ...
    private int mat3int = fc.getInt("Crafts.furnace.10.ingredient");
